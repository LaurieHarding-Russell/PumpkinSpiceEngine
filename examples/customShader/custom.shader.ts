...
export class CustomShader implements ShaderInterface {
    ...
    setTexture(modelReference: TexImageSource | null): void {
        if (modelReference != null) {
            this.webGl.bindTexture(this.webGl.TEXTURE_2D, this.program.uniformLocations.texture);
            this.webGl.texImage2D(this.webGl.TEXTURE_2D, 0, this.webGl.RGBA, this.webGl.RGBA, this.webGl.UNSIGNED_BYTE, modelReference);
            ...
            this.webGl.texParameteri(this.webGl.TEXTURE_2D, this.webGl.TEXTURE_MAG_FILTER, this.webGl.NEAREST_MIPMAP_NEAREST);
        } else {
