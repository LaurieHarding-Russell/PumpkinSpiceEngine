import { Buffers, VALUES_PER_VERT, bufferStride, VALUES_PER_NORMAL, VALUES_PER_TEXTURE_COORDINATES } from "./buffer-factory";
...
import { matrixFromLocationRotation } from "../util";

// We want all methods in here to essentially be static functions.
export class MainShader implements ShaderInterface {
    program!: MainShaderProgramInfo; 
    ...
    initMainShaderProgram(shaderProgram: WebGLProgram, buffers: Buffers): ShaderProgramInfo {
        ...
        const programInfo: MainShaderProgramInfo = {
            program: shaderProgram,
            type: ShadersType.main,
            attribLocations: {
...
export interface MainShaderProgramInfo extends ShaderProgramInfo {
    type: ShadersType.main,
